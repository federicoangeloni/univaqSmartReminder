<%@ Control Language="C#" AutoEventWireup="true" CodeFile="NavbarLogged.ascx.cs" Inherits="UserControl_NavbarLogged" %>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse navbar-ex1-collapse">
                        <ul class="nav navbar-nav js-nav-add-active-class">
                            <li><a href="Home.aspx#" id="buttonNavHome">Home</a></li>
                            <li><a href="Home.aspx#sectionRiepilogo">Il mio riepilogo</a></li>
                            <li><a href="Home.aspx#sectionMeteo" id="buttonNavMeteo">Ora & Meteo</a></li>
                            <li><a href="Home.aspx#sectionAuleLibere" id="buttonNavAule">Aule Libere</a></li>
                            <li><a href="Home.aspx#sectionAvvisiPersonali" id="buttonNavAvvisi">I Miei Avvisi</a></li>
                            <li><a href="Home.aspx#sectionScadenze" id="buttonNavScadenze">Scadenze & Eventi</a></li>
                        ...
                        <ul class="nav navbar-nav navbar-right hidden-xs hidden-sm">
                            <asp:Button ID="btnLogout" CssClass="navbar-btn btn btn-gradient-blue" runat="server" Text="Logout" OnClick="btnLogout_Click" />
                        </ul>
                    </div>
                    <!-- /.navbar-collapse -->
                </div>
