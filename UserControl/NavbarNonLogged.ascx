<%@ Control Language="C#" AutoEventWireup="true" CodeFile="NavbarNonLogged.ascx.cs" Inherits="Navbar" %>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse navbar-ex1-collapse">
                        <ul class="nav navbar-nav js-nav-add-active-class">
                            <li><a href="#" id="buttonNavHome">Home</a></li>
                            <li><a href="#sectionMeteo" id="buttonNavMeteo">Ora & Meteo</a></li>
                            <li><a href="#sectionAuleLibere" id="buttonNavAule">Aule Libere</a></li>
                            <li><a href="#sectionAvvisi" id="buttonNavAvvisi">Ultimi Avvisi</a></li>
                            <li><a href="#sectionScadenze" id="buttonNavScadenze">Scadenze & Eventi</a></li>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div>
                            <asp:Label ID="labelEsitoLogin" runat="server" ForeColor="Red" Class="text-center"></asp:Label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-footer">
                <asp:Button ID="btnDismiss" CssClass="btn btn-default" data-dismiss="modal" runat="server" Text="Annulla" />
